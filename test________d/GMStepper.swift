...
@IBDesignable public class GMStepper: UIControl {
    ...
    @objc @IBInspectable public var buttonsBackgroundColor: UIColor = .clear
    {
        didSet {
            for button in [leftButton, rightButton] {
    ...
    @objc @IBInspectable public var labelBackgroundColor: UIColor = .clear {
        didSet {
    ...
    @objc public var labelFont = UIFont(name: "AvenirNext-Bold", size: 14)! {
        didSet {
    ...
    @objc @IBInspectable public var limitHitAnimationColor: UIColor = .white
    ...
    */
    ...
    func setup() {
        ...
        layer.borderWidth = 1
        layer.borderColor = UIColor(red: 0.325, green: 0.325, blue: 0.325, alpha: 1).cgColor
        clipsToBounds = true
    ...
    public override func layoutSubviews() {
        let buttonWidth = bounds.size.width * ((1 - labelWidthWeight) / 2) + 20
        let labelWidth = bounds.size.width * labelWidthWeight - 40
